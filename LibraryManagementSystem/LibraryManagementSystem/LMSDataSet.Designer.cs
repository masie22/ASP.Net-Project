...
SELECT UserID, Name, Contact_No, Program, Level, Role, Username, Password FROM UserTable WHERE (UserID = @UserID)";
        ...
        public virtual int Fill(LMSDataSet.UserTableDataTable dataTable) {
        ...
        public virtual LMSDataSet.UserTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LMSDataSet.UserTableDataTable dataTable = new LMSDataSet.UserTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LMSDataSet.UserTableDataTable dataTable) {
